...
use tfmttools::tfmt::new_interpreter::Interpreter;
use tfmttools::tfmt::new_lexer::{Lexer, LexerResult};
use tfmttools::tfmt::new_parser::Parser;
use tfmttools::tfmt::new_semantic::SemanticAnalyzer;
...
fn file_test(
    ...
    let output: std::result::Result<
        Vec<String>,
        tfmttools::new_error::InterpreterError,
    > = iter
        .map(|s| {
