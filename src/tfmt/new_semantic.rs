use crate::new_error::SemanticError;
use crate::tfmt::new_ast::{self as ast, Node};
use crate::tfmt::new_token::Token;
use crate::tfmt::new_visitor::Visitor;
use log::info;
...
mod tests {
    use super::*;
    use crate::tfmt::new_ast::{self as ast};
    use crate::tfmt::new_lexer::Lexer;
    use crate::tfmt::new_parser::Parser;
    use anyhow::Result;
